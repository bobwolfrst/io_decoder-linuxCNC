...
io_decoder - USB Operator Panel Interface for LinuxCNC
---
...
<div class="nav-container">
  ...
  <a href="https://github.com/bobwolfrst/io_decoder-linuxCNC/blob/main/docs/README.en.md" class="nav-btn">📖 Manual</a>
